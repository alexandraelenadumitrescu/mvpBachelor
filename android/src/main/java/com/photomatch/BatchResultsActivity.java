...
public class BatchResultsActivity extends BaseActivity {
    ...
    private class ResultsAdapter extends RecyclerView.Adapter<ResultsAdapter.VH> {
        ...
        public void onBindViewHolder(VH holder, int position) {
            ...
            // Original thumbnail — use result.index to handle failed/skipped photos
            if (uriStrings != null && result.index >= 0 && result.index < uriStrings.size()) {
                Uri uri = Uri.parse(uriStrings.get(result.index));
