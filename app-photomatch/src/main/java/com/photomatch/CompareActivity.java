...
public class CompareActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        executor.execute(() -> {
            ...
            byte[] afterBytes = decodeBase64(capturedB64);
            if (afterBytes != null) {
                Bitmap b = BitmapFactory.decodeByteArray(afterBytes, 0, afterBytes.length);
                if (b != null) { histAfter = HistogramUtils.compute(b); b.recycle(); }
            }
    ...
    private FavoritePhoto buildFavorite() {
        ...
        FavoritePhoto f = new FavoritePhoto();
        f.correctedBase64 = correctedB64;
